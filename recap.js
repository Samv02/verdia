      ...
      getDoc(sessionDocRef).then((docSnap) => {
        if (docSnap.exists()) {
          ...
          if (gagnantId) {
            ...
            const gagnantCollection = doc(db, "users", gagnantId);
              ...
              getDoc(gagnantCollection).then((doc) => {
                if (doc.exists) {
                  ...
                  if (user.uid == gagnantId){
                    ...
                    perdant.setAttribute("id", "score_" + scorePerdant);
                    perdant.textContent = "Voici le score de votre adversaire : " + scorePerdant;
                    ...
                    perdant.setAttribute("id", "score_" + scorePerdant);
                    perdant.textContent = "Voici votre score : " + scorePerdant;
                    score.appendChild(perdant);
                  }
                }
              });
